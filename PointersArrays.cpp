...
int main() {
    ...
    *pPointer = 10; //assign a value to the first element
    ...
    pPointer++;
    *pPointer = 20; //assign a value to a second element
    ...
    *pPointer = 30; //assign the value to the third element
    ...
    /*assign the address of the forth element to the pointer using pointer arithmetic*/
    pPointer = numbersArray + 3;
    *pPointer = 40; // assign a value to the forth element

    //assign the address to the firth element to the pointer
    pPointer = numbersArray;

    /*assign a value to the firth element using indirection and pointer arithmetic*/
    *(pPointer+4) = 50;
